...
test.describe('SearchbarComponent', () => {
  test.describe('Default story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-searchbar--default&viewMode=story',
      );
  ...
  test.describe('WithPlaceholder story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-searchbar--with-placeholder&viewMode=story',
      );
      await page.locator('npn-searchbar').waitFor();
    });
  ...
  test.describe('WithValue story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-searchbar--with-value&viewMode=story',
      );
      await page.locator('npn-searchbar').waitFor();
    });
