...
test.describe('StepperDialogComponent', () => {
  test.describe('Default story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-stepperdialog--default&viewMode=story',
      );
  ...
  test.describe('SecondStep story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-stepperdialog--second-step&viewMode=story',
      );
      await page.locator('.p-dialog').waitFor();
    });
  ...
  test.describe('TwoStepDialog story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-stepperdialog--two-step-dialog&viewMode=story',
      );
      await page.locator('.p-dialog').waitFor();
    });
  ...
  test.describe('Hidden story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-stepperdialog--hidden&viewMode=story',
      );
