...
test.describe('StepPanelComponent', () => {
  test.describe('Default story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-steppanel--default&viewMode=story',
      );
  ...
  test.describe('WithOneAction story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-steppanel--with-one-action&viewMode=story',
      );
      await page.locator('npn-step-panel .step').waitFor();
    });
  ...
  test.describe('WithTwoActions story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-steppanel--with-two-actions&viewMode=story',
      );
      await page.locator('npn-step-panel .step').waitFor();
    });
  ...
  test.describe('WithDisabledAction story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-steppanel--with-disabled-action&viewMode=story',
      );
      await page.locator('npn-step-panel .step').waitFor();
    });
  ...
  test.describe('WithSaveAction story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=components-steppanel--with-save-action&viewMode=story',
      );
      await page.locator('npn-step-panel .step').waitFor();
    });
