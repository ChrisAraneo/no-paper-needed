...
test.describe('NoteComponent', () => {
  test.describe('Default story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto('/iframe.html?id=shared-note--default&viewMode=story');
  ...
  test.describe('WithEditButton story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=shared-note--with-edit-button&viewMode=story',
      );
      await page.locator('app-note .container').waitFor();
    });
  ...
  test.describe('WithReminder story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=shared-note--with-reminder&viewMode=story',
      );
      await page.locator('app-note .container').waitFor();
    });
  ...
  test.describe('WithRecurrence story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=shared-note--with-recurrence&viewMode=story',
      );
      await page.locator('app-note .container').waitFor();
    });
  ...
  test.describe('WithReminderAndRecurrence story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=shared-note--with-reminder-and-recurrence&viewMode=story',
      );
      await page.locator('app-note .container').waitFor();
    });
  ...
  test.describe('LongContent story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=shared-note--long-content&viewMode=story',
      );
      await page.locator('app-note .container').waitFor();
    });
  ...
  test.describe('MonthlyRecurrence story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=shared-note--monthly-recurrence&viewMode=story',
      );
      await page.locator('app-note .container').waitFor();
    });
