...
test.describe('TextComponent', () => {
  test.describe('Default story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto('/iframe.html?id=shared-text--default&viewMode=story');
  ...
  test.describe('LongText story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto('/iframe.html?id=shared-text--long-text&viewMode=story');
      await page.locator('npn-text span').waitFor();
    });
  ...
  test.describe('Empty story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto('/iframe.html?id=shared-text--empty&viewMode=story');
