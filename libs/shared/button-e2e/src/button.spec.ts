...
test.describe('ButtonComponent', () => {
  test.describe('Default story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto('/iframe.html?id=shared-button--default&viewMode=story');
  ...
  test.describe('Disabled story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto('/iframe.html?id=shared-button--disabled&viewMode=story');
      await page.locator('npn-button button').waitFor();
    });
  ...
  test.describe('WithIcon story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=shared-button--with-icon&viewMode=story',
      );
      await page.locator('npn-button button').waitFor();
    });
  ...
  test.describe('IconOnly story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto(
        '/iframe.html?id=shared-button--icon-only&viewMode=story',
      );
      await page.locator('npn-button button').waitFor();
    });
  ...
  test.describe('Success story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto('/iframe.html?id=shared-button--success&viewMode=story');
      await page.locator('npn-button button').waitFor();
    });
  ...
  test.describe('Danger story', () => {
    test.beforeEach(async ({ page }) => {
      await page.goto('/iframe.html?id=shared-button--danger&viewMode=story');
      await page.locator('npn-button button').waitFor();
    });
